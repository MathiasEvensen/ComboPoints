...
local function CreateConfigPanel()
    ...
    AddSlider(layoutPage, "Point width", "pointWidth", -48, 8, 100, 1, 10, 468)
    AddSlider(layoutPage, "Point height", "pointHeight", -116, 8, 100, 1, 10, 468)
    AddSlider(layoutPage, "Spacing", "spacing", -184, 0, 50, 1, 10, 468)
